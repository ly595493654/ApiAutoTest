...
# register http://192.168.150.54:8089/
url = "http://192.168.150.54:8089/futureloan/mvc/api/member/list"
r = requests.get(url)  # 对结果进行检查
print(r.text)
print(r.json())
r = r.json()
assert r["status"] == 1
...
# get请求带参数,方式一:拼接到URL后面,?参数名1=参数值1&参数值
# 注册接口
url = "http://192.168.150.54:8089/futureloan/mvc/api/member/register?mobilephone=18165403935&pwd=1234"
r = requests.get(url)
r = r.json()
print(r)
...
user = {
    "mobilephone": "18165003935",
    "pwd": "1234111",
    "regname": "赵凯凯凯凯凯凯凯凯凯凯凯凯凯凯"
}
...
url = "https://tcc.taobao.com/cc/json/mobile_tel_segment.htm?tel=13572338555"
r = requests.get(url)
print(r.text)
print(type(r))
